...
var Emitter=function(){function e(){_classCallCheck(this,e)}_createClass(e,[{key:"on",value:function(d,a){this._callbacks=this._callbacks||{};this._callbacks[d]||(this._callbacks[d]=[]);this._callbacks[d].push(a);return this}},{key:"emit",value:function(d){this._callbacks=this._callbacks||{};var a=this._callbacks[d];if(a){for(var b=arguments.length,c=Array(1<b?b-1:0),f=1;f<b;f++)c[f-1]=arguments[f];for(b=0;!(b>=a.length);)a[b++].apply(this,c)}return this}},{key:"off",value:function(d,a){if(!this._callbacks||
    ...
    {key:"getQueuedFiles",value:function(){return this.getFilesWithStatus(d.QUEUED)}},{key:"getUploadingFiles",value:function(){return this.getFilesWithStatus(d.UPLOADING)}},{key:"getAddedFiles",value:function(){return this.getFilesWithStatus(d.ADDED)}},{key:"getActiveFiles",value:function(){return this.files.filter(function(a){return a.status===d.UPLOADING||a.status===d.QUEUED}).map(function(a){return a})}},{key:"init",value:function(){var a=this;"form"===this.element.tagName&&this.element.setAttribute("enctype",
        ...
        value:function(){return this.listeners.map(function(a){var b=[],c;for(c in a.events)b.push(a.element.addEventListener(c,a.events[c],!1));return b})}},{key:"removeEventListeners",value:function(){return this.listeners.map(function(a){var b=[],c;for(c in a.events)b.push(a.element.removeEventListener(c,a.events[c],!1));return b})}},{key:"disable",value:function(){var a=this;this.clickableElements.forEach(function(a){return a.classList.remove("dz-clickable")});this.removeEventListeners();return this.files.map(function(b){return a.cancelUpload(b)})}},
    {key:"enable",value:function(){this.clickableElements.forEach(function(a){return a.classList.add("dz-clickable")});return this.setupEventListeners()}},{key:"filesize",value:function(a){var b=0,c="b";if(0<a){for(var f=["tb","gb","mb","kb","b"],d=0;d<f.length;d++){var e=f[d];if(a>=Math.pow(this.options.filesizeBase,4-d)/10){b=a/Math.pow(this.options.filesizeBase,4-d);c=e;break}}b=Math.round(10*b)/10}return"<strong>"+b+"</strong> "+this.options.dictFileSizeUnits[c]}},{key:"_updateMaxFilesReachedClass",
        value:function(){return null!=this.options.maxFiles&&this.getAcceptedFiles().length>=this.options.maxFiles?(this.getAcceptedFiles().length===this.options.maxFiles&&this.emit("maxfilesreached",this.files),this.element.classList.add("dz-max-files-reached")):this.element.classList.remove("dz-max-files-reached")}},{key:"drop",value:function(a){if(a.dataTransfer){this.emit("drop",a);var b=a.dataTransfer.files;this.emit("addedfiles",b);b.length&&((a=a.dataTransfer.items)&&a.length&&null!=a[0].webkitGetAsEntry?
            this._addFilesFromItems(a):this.handleFiles(b))}}},{key:"paste",value:function(a){if(null!=__guard__(null!=a?a.clipboardData:void 0,function(a){return a.items})&&(this.emit("paste",a),a=a.clipboardData.items,a.length))return this._addFilesFromItems(a)}},{key:"handleFiles",value:function(a){var b=this;return a.map(function(a){return b.addFile(a)})}},{key:"_addFilesFromItems",value:function(a){for(var b=[],c=0;!(c>=a.length);){var d=a[c++],g;null!=d.webkitGetAsEntry&&(g=d.webkitGetAsEntry())?g.isFile?
            b.push(this.addFile(d.getAsFile())):g.isDirectory?b.push(this._addFilesFromDirectory(g,g.name)):b.push(void 0):null!=d.getAsFile?null==d.kind||"file"===d.kind?b.push(this.addFile(d.getAsFile())):b.push(void 0):b.push(void 0)}return b}},{key:"_addFilesFromDirectory",value:function(a,b){var c=this,d=a.createReader(),g=function(a){return __guardMethod__(console,"log",function(b){return b.log(a)})};return function h(){return d.readEntries(function(a){if(0<a.length){for(var d=0;!(d>=a.length);){var f=
            a[d++];f.isFile?f.file(function(a){if(!c.options.ignoreHiddenFiles||"."!==a.name.substring(0,1))return a.fullPath=b+"/"+a.name,c.addFile(a)}):f.isDirectory&&c._addFilesFromDirectory(f,b+"/"+f.name)}h()}return null},g)}()}},{key:"accept",value:function(a,b){return a.size>1048576*this.options.maxFilesize?b(this.options.dictFileTooBig.replace("{{filesize}}",Math.round(a.size/1024/10.24)/100).replace("{{maxFilesize}}",this.options.maxFilesize)):d.isValidFile(a,this.options.acceptedFiles)?null!=this.options.maxFiles&&
        this.getAcceptedFiles().length>=this.options.maxFiles?(b(this.options.dictMaxFilesExceeded.replace("{{maxFiles}}",this.options.maxFiles)),this.emit("maxfilesexceeded",a)):this.options.accept.call(this,a,b):b(this.options.dictInvalidFileType)}},{key:"addFile",value:function(a){var b=this;a.upload={uuid:d.uuidv4(),progress:0,total:a.size,bytesSent:0,filename:this._renameFile(a),chunked:this.options.chunking&&(this.options.forceChunking||a.size>this.options.chunkSize),totalChunkCount:Math.ceil(a.size/
                this.options.chunkSize)};this.files.push(a);a.status=d.ADDED;this.emit("addedfile",a);this._enqueueThumbnail(a);return this.accept(a,function(c){c?(a.accepted=!1,b._errorProcessing([a],c)):(a.accepted=!0,b.options.autoQueue&&b.enqueueFile(a));return b._updateMaxFilesReachedClass()})}},{key:"enqueueFiles",value:function(a){for(var b=0;!(b>=a.length);){var c=a[b++];this.enqueueFile(c)}return null}},{key:"enqueueFile",value:function(a){var b=this;if(a.status===d.ADDED&&!0===a.accepted){if(a.status=d.QUEUED,
                this.options.autoProcessQueue)return setTimeout(function(){return b.processQueue()},0)}else throw Error("This file can't be queued because it has already been processed or was rejected.");}},{key:"_enqueueThumbnail",value:function(a){var b=this;if(this.options.createImageThumbnails&&a.type.match(/image.*/)&&a.size<=1048576*this.options.maxThumbnailFilesize)return this._thumbnailQueue.push(a),setTimeout(function(){return b._processThumbnailQueue()},0)}},{key:"_processThumbnailQueue",value:function(){var a=
            this;if(!this._processingThumbnail&&0!==this._thumbnailQueue.length){this._processingThumbnail=!0;var b=this._thumbnailQueue.shift();return this.createThumbnail(b,this.options.thumbnailWidth,this.options.thumbnailHeight,this.options.thumbnailMethod,!0,function(c){a.emit("thumbnail",b,c);a._processingThumbnail=!1;return a._processThumbnailQueue()})}}},{key:"removeFile",value:function(a){a.status===d.UPLOADING&&this.cancelUpload(a);this.files=without(this.files,a);this.emit("removedfile",a);if(0===
            this.files.length)return this.emit("reset")}},{key:"removeAllFiles",value:function(a){null==a&&(a=!1);for(var b=this.files.slice(),c=0;!(c>=b.length);){var f=b[c++];(f.status!==d.UPLOADING||a)&&this.removeFile(f)}return null}},{key:"resizeImage",value:function(a,b,c,f,g){var e=this;return this.createThumbnail(a,b,c,f,!1,function(b,c){if(null===c)return g(a);var f=e.options.resizeMimeType;null==f&&(f=a.type);var h=c.toDataURL(f,e.options.resizeQuality);if("image/jpeg"===f||"image/jpg"===f)h=ExifRestore.restore(a.dataURL,
            h);return g(d.dataURItoBlob(h))})}},{key:"createThumbnail",value:function(a,b,c,d,g,e){var f=this,k=new FileReader;k.onload=function(){a.dataURL=k.result;if("image/svg+xml"===a.type)null!=e&&e(k.result);else return f.createThumbnailFromUrl(a,b,c,d,g,e)};return k.readAsDataURL(a)}},{key:"createThumbnailFromUrl",value:function(a,b,c,d,g,e,h){var f=this,l=document.createElement("img");h&&(l.crossOrigin=h);l.onload=function(){var h=function(a){return a(1)};"undefined"!==typeof EXIF&&null!==EXIF&&g&&(h=
            function(a){return EXIF.getData(l,function(){return a(EXIF.getTag(this,"Orientation"))})});return h(function(g){a.width=l.width;a.height=l.height;var h=f.options.resize.call(f,a,b,c,d),k=document.createElement("canvas"),m=k.getContext("2d");k.width=h.trgWidth;k.height=h.trgHeight;4<g&&(k.width=h.trgHeight,k.height=h.trgWidth);switch(g){case 2:m.translate(k.width,0);m.scale(-1,1);break;case 3:m.translate(k.width,k.height);m.rotate(Math.PI);break;case 4:m.translate(0,k.height);m.scale(1,-1);break;case 5:m.rotate(.5*
            Math.PI);m.scale(1,-1);break;case 6:m.rotate(.5*Math.PI);m.translate(0,-k.height);break;case 7:m.rotate(.5*Math.PI);m.translate(k.width,-k.height);m.scale(-1,1);break;case 8:m.rotate(-.5*Math.PI),m.translate(-k.width,0)}drawImageIOSFix(m,l,null!=h.srcX?h.srcX:0,null!=h.srcY?h.srcY:0,h.srcWidth,h.srcHeight,null!=h.trgX?h.trgX:0,null!=h.trgY?h.trgY:0,h.trgWidth,h.trgHeight);g=k.toDataURL("image/png");if(null!=e)return e(g,k)})};null!=e&&(l.onerror=e);return l.src=a.dataURL}},{key:"processQueue",value:function(){var a=
            this.options.parallelUploads,b=this.getUploadingFiles().length,c=b;if(!(b>=a)){var d=this.getQueuedFiles();if(0<d.length){if(this.options.uploadMultiple)return this.processFiles(d.slice(0,a-b));for(;c<a&&d.length;)this.processFile(d.shift()),c++}}}},{key:"processFile",value:function(a){return this.processFiles([a])}},{key:"processFiles",value:function(a){for(var b=0;!(b>=a.length);){var c=a[b++];c.processing=!0;c.status=d.UPLOADING;this.emit("processing",c)}this.options.uploadMultiple&&this.emit("processingmultiple",
            a);return this.uploadFiles(a)}},{key:"_getFilesWithXhr",value:function(a){return this.files.filter(function(b){return b.xhr===a}).map(function(a){return a})}},{key:"cancelUpload",value:function(a){if(a.status===d.UPLOADING){for(var b=this._getFilesWithXhr(a.xhr),c=0;!(c>=b.length);)b[c++].status=d.CANCELED;"undefined"!==typeof a.xhr&&a.xhr.abort();for(a=0;!(a>=b.length);)c=b[a++],this.emit("canceled",c);this.options.uploadMultiple&&this.emit("canceledmultiple",b)}else if(a.status===d.ADDED||a.status===
            d.QUEUED)a.status=d.CANCELED,this.emit("canceled",a),this.options.uploadMultiple&&this.emit("canceledmultiple",[a]);if(this.options.autoProcessQueue)return this.processQueue()}},{key:"resolveOption",value:function(a){if("function"===typeof a){for(var b=arguments.length,c=Array(1<b?b-1:0),d=1;d<b;d++)c[d-1]=arguments[d];return a.apply(this,c)}return a}},{key:"uploadFile",value:function(a){return this.uploadFiles([a])}},{key:"uploadFiles",value:function(a){var b=this;this._transformFiles(a,function(c){if(a[0].upload.chunked){var f=
            a[0],g=c[0],e=0;f.upload.chunks=[];var h=function(){for(var c=0;void 0!==f.upload.chunks[c];)c++;if(!(c>=f.upload.totalChunkCount)){e++;var h=c*b.options.chunkSize,k=Math.min(h+b.options.chunkSize,f.size);h={name:b._getParamName(0),data:g.webkitSlice?g.webkitSlice(h,k):g.slice(h,k),filename:f.upload.filename,chunkIndex:c};f.upload.chunks[c]={file:f,index:c,dataBlock:h,status:d.UPLOADING,progress:0,retries:0};b._uploadData(a,[h])}};f.upload.finishedChunkUpload=function(c){var g=!0;c.status=d.SUCCESS;
            c.dataBlock=null;for(c=0;c<f.upload.totalChunkCount;c++){if(void 0===f.upload.chunks[c])return h();f.upload.chunks[c].status!==d.SUCCESS&&(g=!1)}g&&b.options.chunksUploaded(f,function(){b._finished(a,"",null)})};if(b.options.parallelChunkUploads)for(c=0;c<f.upload.totalChunkCount;c++)h();else h()}else{for(var k=[],m=0;m<a.length;m++)k[m]={name:b._getParamName(m),data:c[m],filename:a[m].upload.filename};b._uploadData(a,k)}})}},{key:"_getChunk",value:function(a,b){for(var c=0;c<a.upload.totalChunkCount;c++)if(void 0!==
            a.upload.chunks[c]&&a.upload.chunks[c].xhr===b)return a.upload.chunks[c]}},{key:"_uploadData",value:function(a,b){for(var c=this,f=new XMLHttpRequest,g=0;!(g>=a.length);)a[g++].xhr=f;a[0].upload.chunked&&(a[0].upload.chunks[b[0].chunkIndex].xhr=f);g=this.resolveOption(this.options.method,a);var e=this.resolveOption(this.options.url,a);f.open(g,e,!0);f.timeout=this.resolveOption(this.options.timeout,a);f.withCredentials=!!this.options.withCredentials;f.onload=function(b){c._finishedUploading(a,f,b)};
            f.onerror=function(){c._handleUploadError(a,f)};(null!=f.upload?f.upload:f).onprogress=function(b){return c._updateFilesUploadProgress(a,f,b)};g={Accept:"application/json","Cache-Control":"no-cache","X-Requested-With":"XMLHttpRequest"};this.options.headers&&d.extend(g,this.options.headers);for(var h in g)(e=g[h])&&f.setRequestHeader(h,e);h=new FormData;if(this.options.params){g=this.options.params;"function"===typeof g&&(g=g.call(this,a,f,a[0].upload.chunked?this._getChunk(a[0],f):null));for(var k in g)h.append(k,
                g[k])}for(k=0;!(k>=a.length);)g=a[k++],this.emit("sending",g,f,h);this.options.uploadMultiple&&this.emit("sendingmultiple",a,f,h);this._addFormElementData(h);for(k=0;k<b.length;k++)g=b[k],h.append(g.name,g.data,g.filename);this.submitRequest(f,h,a)}},{key:"_transformFiles",value:function(a,b){for(var c=this,d=[],g=0,e=function(f){c.options.transformFile.call(c,a[f],function(c){d[f]=c;++g===a.length&&b(d)})},h=0;h<a.length;h++)e(h)}},{key:"_addFormElementData",value:function(a){if("FORM"===this.element.tagName)for(var b=
            this.element.querySelectorAll("input, textarea, select, button"),c=0;!(c>=b.length);){var d=b[c++],e=d.getAttribute("name"),l=d.getAttribute("type");l&&(l=l.toLowerCase());if("undefined"!==typeof e&&null!==e)if("SELECT"===d.tagName&&d.hasAttribute("multiple"))for(d=d.options,l=0;!(l>=d.length);){var h=d[l++];h.selected&&a.append(e,h.value)}else(!l||"checkbox"!==l&&"radio"!==l||d.checked)&&a.append(e,d.value)}}},{key:"_updateFilesUploadProgress",value:function(a,b,c){if("undefined"!==typeof c){var d=
            100*c.loaded/c.total;if(a[0].upload.chunked){var e=a[0];b=this._getChunk(e,b);b.progress=d;b.total=c.total;b.bytesSent=c.loaded;e.upload.progress=0;e.upload.total=0;for(d=e.upload.bytesSent=0;d<e.upload.totalChunkCount;d++)void 0!==e.upload.chunks[d]&&void 0!==e.upload.chunks[d].progress&&(e.upload.progress+=e.upload.chunks[d].progress,e.upload.total+=e.upload.chunks[d].total,e.upload.bytesSent+=e.upload.chunks[d].bytesSent);e.upload.progress/=e.upload.totalChunkCount}else for(e=0;!(e>=a.length);)b=
            a[e++],b.upload.progress=d,b.upload.total=c.total,b.upload.bytesSent=c.loaded;for(d=0;!(d>=a.length);)c=a[d++],this.emit("uploadprogress",c,c.upload.progress,c.upload.bytesSent)}else{c=!0;d=100;for(e=0;!(e>=a.length);){b=a[e++];if(100!==b.upload.progress||b.upload.bytesSent!==b.upload.total)c=!1;b.upload.progress=d;b.upload.bytesSent=b.upload.total}if(!c)for(c=0;!(c>=a.length);)e=a[c++],this.emit("uploadprogress",e,d,e.upload.bytesSent)}}},{key:"_finishedUploading",value:function(a,b,c){var f=void 0;
            if(a[0].status!==d.CANCELED&&4===b.readyState){if("arraybuffer"!==b.responseType&&"blob"!==b.responseType&&(f=b.responseText,b.getResponseHeader("content-type")&&~b.getResponseHeader("content-type").indexOf("application/json")))try{f=JSON.parse(f)}catch(g){c=g,f="Invalid JSON response from server."}this._updateFilesUploadProgress(a);200<=b.status&&300>b.status?a[0].upload.chunked?a[0].upload.finishedChunkUpload(this._getChunk(a[0],b)):this._finished(a,f,c):this._handleUploadError(a,b,f)}}},{key:"_handleUploadError",
        value:function(a,b,c){if(a[0].status!==d.CANCELED){if(a[0].upload.chunked&&this.options.retryChunks){var f=this._getChunk(a[0],b);if(f.retries++<this.options.retryChunksLimit){this._uploadData(a,[f.dataBlock]);return}console.warn("Retried this chunk too often. Giving up.")}for(f=0;!(f>=a.length);)f++,this._errorProcessing(a,c||this.options.dictResponseError.replace("{{statusCode}}",b.status),b)}}},{key:"submitRequest",value:function(a,b,c){a.send(b)}},{key:"_finished",value:function(a,b,c){for(var f=
            0;!(f>=a.length);){var e=a[f++];e.status=d.SUCCESS;this.emit("success",e,b,c);this.emit("complete",e)}this.options.uploadMultiple&&(this.emit("successmultiple",a,b,c),this.emit("completemultiple",a));if(this.options.autoProcessQueue)return this.processQueue()}},{key:"_errorProcessing",value:function(a,b,c){for(var e=0;!(e>=a.length);){var g=a[e++];g.status=d.ERROR;this.emit("error",g,b,c);this.emit("complete",g)}this.options.uploadMultiple&&(this.emit("errormultiple",a,b,c),this.emit("completemultiple",
            a));if(this.options.autoProcessQueue)return this.processQueue()}}],[{key:"uuidv4",value:function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0;return("x"===a?b:b&3|8).toString(16)})}}]);return d}(Emitter);Dropzone.initClass();Dropzone.version="5.3.0";Dropzone.options={};Dropzone.optionsForElement=function(e){if(e.getAttribute("id"))return Dropzone.options[camelize(e.getAttribute("id"))]};Dropzone.instances=[];
